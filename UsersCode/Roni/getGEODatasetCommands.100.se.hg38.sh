...
echo "python /home/alu/hillelr/scripts/GGPS/Tools/HyperEditing/HyperEditingRunner.py -d  \$WANTED_DIR/STAR\$SUFFIX -o \$WANTED_DIR/HE\$SUFFIX -os \$WANTED_DIR/HE\$SUFFIX/summary -so \$WANTED_DIR/STAR\$SUFFIX --no_recurring_reads -f lzma -mp 'Unmapped.out.mate' -m2 No2Mate -u lzcat -se >> \$WANTED_DIR/HE\$SUFFIX/runHE_Log.txt" >> $WANTED_DIR/commands$SUFFIX.sh
